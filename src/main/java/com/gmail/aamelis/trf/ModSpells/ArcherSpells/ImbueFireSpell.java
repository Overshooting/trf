...
public class ImbueFireSpell implements ISpell {
    @Override
    public String getId() {
        return "imbue_fire";
    }
    ...
    public void cast(ServerPlayer player) {
        ...
        player.addEffect(new MobEffectInstance(EffectsInit.FIRE_IMBUEMENT_EFFECT, duration));
    }
    ...
    public ResourceLocation getFullPath() {
        return ResourceLocation.fromNamespaceAndPath(TRFFinalRegistry.MODID, "textures/gui/cooldowns/imbue_fire_full.png");
    }

    @Override
    public ResourceLocation getEmptyPath() {
        return ResourceLocation.fromNamespaceAndPath(TRFFinalRegistry.MODID, "textures/gui/cooldowns/imbue_fire_empty.png");
    }

    @Override
    public ResourceLocation animationId() {
        return ResourceLocation.fromNamespaceAndPath(TRFFinalRegistry.MODID, "animation.player.cast_imbue_fire");
    }
}
