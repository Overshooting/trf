...
public class FrostImbuementEffect extends MobEffect implements ImbuementEffect {

    public FrostImbuementEffect(MobEffectCategory category, int color) {
    ...
    public void applyEffect(LivingEntity entity, ServerPlayer source) {
        ...
        int duration = 420 - (280 / (data.getPerception() + 1));
