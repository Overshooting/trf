...
public class CastKeybinds {
    ...
    public static final KeyMapping.Category CATEGORY = new KeyMapping.Category(
            ResourceLocation.fromNamespaceAndPath(TRFFinalRegistry.MODID, "spell_keys"));

    public static final KeyMapping SPELL_C =
            new KeyMapping("key.trf.spell_c",
                    InputConstants.Type.KEYSYM,
                    GLFW.GLFW_KEY_C,
                    CATEGORY);

    public static final KeyMapping SPELL_V =
            new KeyMapping("key.trf.spell_v",
                    InputConstants.Type.KEYSYM,
                    GLFW.GLFW_KEY_V,
                    CATEGORY);

    public static final KeyMapping SPELL_B =
            new KeyMapping("key.trf.spell_b",
                    InputConstants.Type.KEYSYM,
                    GLFW.GLFW_KEY_B,
                    CATEGORY);
